          ...
          <Center>
            <Box m={1} p={1} flex="1" >
              ...
              <Flex direction="row" width="full"  mt={5}>
                <Spacer />
                <Button mr={40} onClick={() => handleCardClick()}>Expand Student List</Button>
                <Input
                  w="240px"
                  h="32px"
                  type="file"
                      ...
                      <Center>
                        ...
                        >
                          <SimpleGrid  spacing={1} columns={2}>
                            ...
                            <Text>ESE: {student.isESE ? "Yes" : "No"}</Text>
                            <Text>504: {student.has504 ? "Yes" : "No"}</Text>
                            <Text>ELL: {student.isELL ? "Yes" : "No"}</Text>
                            <Text>EBD: {student.isEBD ? "Yes" : "No"}</Text>
                          </SimpleGrid>
                        </Stack>
                      </Center>
